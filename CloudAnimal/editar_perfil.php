	...
	<div class="e-mid">
		...
		<form action="" method="post">
			...
			if(isset($_POST['editar'])) {
				...
				$sqlE = $mysqli->query("UPDATE users SET name = '$nombre', username = '$username', bio = '$bio', email = '$email', sex = '$sexo' WHERE id = '".$_SESSION['id']."'");
		...
		<div class="e-right">
			<div class="e-contenido">
				<div class="e-title"><img src="imagenes/<?php echo $rowA['avatar']; ?>" width="60"></div>
			...
			<div class="e-contenido">
				...
				<div class="e-input">
					<select name="sexo" enabled=""<?php echo $rowA['sex']; ?>>
