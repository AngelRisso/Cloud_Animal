...
<div class="h-content">
	...
	<div class="p-top">
		...
		<div class="p-info">
			...
			<div class="p-infor"><b><?php echo $totalSe; ?></b> siguiendo</div>
		</div>
		<div class="p-nombre"><?php echo $rowA['name'];?></div>
		<div class="p-location">Chile, Santiago</div>
	...
	<div class="p-mid">
		...
		?>
			<div class="p-pub" style="background-image: none"> 
			<img src="data:image/*;base64, <?php echo base64_encode($rowD['imagen']); ?>"class="<?php echo $rowD['filtro']; ?>"width="300px" height="300px">
			</div>
		<?php } ?>
