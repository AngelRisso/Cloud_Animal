...
<body>
	...
	$status = "Activo ahora";
	$estado = mysqli_query($mysqli, "UPDATE users SET status = '{$status}' WHERE id = '".$_SESSION['id']."'");
	...
	<div class="h-content">
		...
		<div class="h-left">
			...
			?>
				...
				<div class="hl-cont">
					<div class="hl-top">
					<div><h1><?php echo ($rowA['id']);?></h1></div>
					...
					<div class="hl-middle">
						<img src="data:image/*;base64, <?php echo base64_encode($rowC['imagen']); ?>" width="100%" class="<?php echo $rowC['filtro']; ?>">
					</div>
					<div class="hl-section-likes">
						...
						<?php if ($cLikes == 0) { ?>
							<div id="Com<?php echo $rowA['id']; ?>" class="Com"  style="float: left; cursor: pointer;"><img src="images/icons/comentario.png"></div>
						<?php } else { ?>
							<div id="Com<?php echo $rowA['id']; ?>" class="Com" style="float: left; cursor: pointer;"><img src="images/icons/comentario.png"></div>
						<?php } ?>
					...
					<form action="comentario.php" method="POST">
						<input type="text" hidden name="idcom" value="<?php echo $rowA['id']; ?>">
							<input type="submit" name="btm" value="ver comentario">
					</form>
				</div>
